...
- If you'd like a little cli wrapper-script, check out [the one in ashlaros](https://github.com/ashlaros/ashlaros/blob/main/packages/ashlaros-settings/payload/usr/bin/mjr), which takes a url as an argument or on stdin so it chains off other commands
