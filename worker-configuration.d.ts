/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f74973c55d282db068dd8e0a64827bdb)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SALT" | "SAFE_BROWSING_API_KEY">> {}
}
